...
| notebook/experimento/promoção de componente de dados | ADR-0003, 0005, 0007, 0009; 0015/0016 (propostos quando aplicáveis) | data science lifecycle, processing profile, ambientes, entrega | document/module/impact + CI/benchmark | ADR apenas se mudar boundary, dados, segurança ou implantação; promoção sempre registrada |
...
| Docling/layout/tabelas/ordem de leitura | ADR-0016 (proposto) | provider strategy, pipeline, processing profile, data science lifecycle, ambientes | document/module/entity/impact + componentes/deployment | spike CPU-only e benchmark por capability antes de promoção |
