...
| --- | --- | --- | --- |
| [`README.md`](../../README.md) | entrada curta do repositório | vigente | portal, status, execução R0 e limites do recorte relacional da #39 |
...
| [`docs/project/PROJECT_STATUS.md`](../project/PROJECT_STATUS.md) | snapshot de fase, gate e fila | vigente | Issues #1, #26, #33–#37, #39, #73, #88 e #96; Phase 1/R0 encerrada e #39 em revisão |
...
| [`docs/operations/DEVELOPMENT_COMPOSE.md`](../operations/DEVELOPMENT_COMPOSE.md) | runbook do Compose de desenvolvimento | implementado para desenvolvimento | #36/PR #94, #96/PR #97 e #39; API/web em 8100/5180 e PostgreSQL somente interno |
| [`docs/operations/VALIDACAO_LOCAL_CI.md`](../operations/VALIDACAO_LOCAL_CI.md) | runbook equivalente ao Application CI | integrado e ampliado pela #39 | checks técnicos, migration e testes PostgreSQL; ainda não comprova storage/upload/telas |
| [`apps/api/README.md`](../../apps/api/README.md) | execução e validação da API e persistência | implementado parcialmente | #34/PR #90 e #39; HTTP limitado a `GET /health`, com domínio/schema/repositórios sem upload |
...
| [`docs/architecture/DATA_MODEL_BASELINE.md`](../architecture/DATA_MODEL_BASELINE.md) | conceitos e invariantes; não é especificação física | parcial | recorte relacional de intake materializado pela #39; demais conceitos seguem planejados |
...
| [`docs/architecture/INTAKE_PERSISTENCE_STORAGE_CONTRACT.md`](../architecture/INTAKE_PERSISTENCE_STORAGE_CONTRACT.md) | contrato do intake local sintético | ratificado; recorte relacional implementado nesta revisão | #38/#92/PR #95 e #39; storage, upload e telas seguem não implementados |
